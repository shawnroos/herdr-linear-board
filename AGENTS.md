...
schema v15
live catalog is `e2e/README.md` (scenarios 01–40); `e2e/test-harness.sh` is the provider-free static
safety gate.
...
- End-to-end: `e2e/run-all.sh` (compat: `scripts/e2e.sh`) drives a REAL Herdr; checked-in fake
  Pi/Claude/Codex/OpenCode/Antigravity (`agy`) executables keep the standard suite (scenarios 01–40) provider-free and zero-cost.
