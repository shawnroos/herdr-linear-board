...
is [`../e2e/README.md`](../e2e/README.md), scenarios **01–40** (through `e2e/40-linear-mode.sh`); the safe
...
- E: scenarios `e2e/01-core.sh` through `e2e/40-linear-mode.sh` (real Herdr 0.9.0 / socket
