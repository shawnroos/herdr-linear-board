...
is [`../e2e/README.md`](../e2e/README.md), scenarios **01–42** (through `e2e/42-linear-issue.sh`); the safe
...
- E: scenarios `e2e/01-core.sh` through `e2e/42-linear-issue.sh` (real Herdr 0.9.0 / socket
